...
from Losses import GradNorm


class TrainStepsForMultiTask(TrainSteps):
    def __init__(self, training_batch_size, eval_batch_size, epoches, gradient_adjust_fn=lambda x: x):
        super(TrainStepsForMultiTask, self).__init__(training_batch_size, eval_batch_size, epoches)
